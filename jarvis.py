...
def listenCommand():
    ...
    with speech_recognition.Microphone() as source:
        # print("Setting up...")
        # listener.adjust_for_ambient_noise(source, duration=.5) # In this line system will take 1 sec to adjust itself for environment noise  
...
speak('Hello. I am Jarvis. Tony Stark\'s personal virtual assistant.')    
# command = listenCommand()

# if 'jarvis' in command:
#     speak("Yes Sir. I am alive aware and ready to follow your command.")
# else:
#     speak("sorry sir! unable to follow...")
